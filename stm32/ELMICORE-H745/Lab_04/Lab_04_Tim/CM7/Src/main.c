/**
  ******************************************************************************
  * @file    Templates/Lab_04_Tim/CM7/Src/main.c
 ...
 /* STM32H7xx HAL library initialization:
  ...
  /* Configure LED1 */
    ...
    */
    ...
    TimHandle.Init.Period            = 20000000 / freq0 - 1;
    ...
    while (1)
    {
      if (__HAL_TIM_GET_FLAG(&TimHandle, TIM_FLAG_UPDATE))
      {
        ...
        if (cnt == limit) {
        	if (first) {
        		limit = freq1;
        		__HAL_TIM_SET_AUTORELOAD(&TimHandle, 20000000 / freq1 - 1);
        	}
        	else {
        		limit = freq0;
        		__HAL_TIM_SET_AUTORELOAD(&TimHandle, 20000000 / freq0 - 1);
        	}
        	cnt = 0;
        	first = !first;
        }
