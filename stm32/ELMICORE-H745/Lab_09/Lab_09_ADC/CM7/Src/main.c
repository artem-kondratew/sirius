...
int main(void)
{
 ...
 /* STM32H7xx HAL library initialization:
  ...
  while (1)
  {
	...
	DACValue = level * 256 / 3.3; // Vref = 3.3V, Vout = 1.5V, 8-bit
    ...
    else
    {
      ...
      printf("%f    %5d ", level, uhADCxConvertedValue);
